...
const MoviePlayer = () => {
  ...
  return (
    <div className='h-screen w-screen relative bg-black'>
      <button
        className='bg-transparent absolute top-4 left-2 bg-gray-800 text-white px-4 py-2 rounded'
      ...
      <button
        className='bg-transparent absolute top-5 right-4 bg-gray-800 text-white px-4 py-2 rounded'
...
<div className=' bg-black h-12 w-24  flex justify-center items-center'><Volume2 strokeWidth={2} className='size-12'/></div>
<div className='flex justify-center w-10/12 '>
<p className='font-bold text-lg'>Sonic Prime</p>
<p className='px-3 text-lg'>E1</p>
<p className='text-lg'>Shattered</p>
</div>
