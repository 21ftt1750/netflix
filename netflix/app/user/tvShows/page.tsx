...
function User() {
  ...
  return (
    <div className='relative w-screen h-screen bg-[#141414]'>
     <Image src={foolme} alt="peaky blinders" className="z-0 w-full h-full brightness-75" />
         
     <div className='absolute top-0 left-0 w-1/2 h-screen  py-20 px-16 text-white'>
        <div className='flex items-center'>
        <p className='text-4xl font-semibold'>TV Shows</p>
  ...
  <option value='drama'>Drama</option>
        ...
        <div className=' flex self-center  mt-28'>
          <Image src={fool} alt='moviename' className='h-56 w-10/12'></Image>
          </div>
        <p className='text-2xl font-semibold my-4'>Watch the Limited Series Now</p>
        <p className=' w-11/12 leading-6 text-lg'>When ex-soldier Maya sees her murdered husband on a secret nanny cam, she uncovers a deadly conspiracy that stretches deep into the past.</p>
       <br />
        <div className=' flex items-center'>
