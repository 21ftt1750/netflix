...
<div
    ...
    <div className=' pt-8 w-screen fixed left-0 top-12 z-10 pb-4  bg-[#141414] text-white flex'>
        <p className=' pl-14 text-3xl  w-1/3'>Browse by Languages</p>
        
        <div className=' w-2/3 flex items-center'>
        <p>Select Your Preferences</p>
        <select className='border bg-black border-white mx-2'>
            <option value="Original Language">Original Language</option>
        </select>
        <select className='border bg-black  border-white mx-2 w-64'>
            <option value="Original Language">English</option>
        </select>
        <p>Sort by</p>
        <select className='border bg-black  border-white mx-2 '>
            <option value="Original Language">Suggestions For You</option>
        </select>
        </div>
    </div>
      <div className='pt-60 w-screen  bg-[#141414] text-white '>
