...
<div
    ...
    <div className='px-5 '>
      ...
      <div className='  w-screen  bg-[#141414] text-white pt-16'>
<p className=' px-14 pb-10  text-3xl fixed z-10 pt-5 w-screen bg-[#141414]'>My List</p>
        <div className=' w-screen flex justify-center pt-44 z-0'>
        <Carousel
  opts={{
    align: "start",
  }}
...
>
  <CarouselContent>
    ...
    <Link href="/user/moviePlayer">    <Image width={11200} height={96} src={row.imageLink} alt="" className='rounded-sm' />  </Link>          
      ...
      <div className=' w-screen bg-[#141414] text-[#808080] pt-96'>
        <div className='flex justify-center pt-96 px-64'>
          <div className='grid grid-cols-4  w-full gap-3 text-xs px-4 pt-32'>
